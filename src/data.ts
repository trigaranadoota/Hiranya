...
import { Collection, Product, Partner, Boutique } from "./types";
...
export const partners: Partner[] = [
  {
    ...
    description: "The premier global conservation enterprise solely dedicated to protecting the world's 40 wild cat species. Hiranya directly supports Panthera's Snow Leopard camera grid surveillance and range tracker collars.",
...
export const boutiques: Boutique[] = [
  {
    ...
    email: "geneva@hiranyajewelry.com"
  },
  {
    city: "London Salon",
    ...
    email: "london@hiranyajewelry.com"
  },
  {
    ...
    email: "newyork@hiranyajewelry.com"
  }
];
